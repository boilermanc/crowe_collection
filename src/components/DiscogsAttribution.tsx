...
const DiscogsAttribution: React.FC<DiscogsAttributionProps> = ({ size }) => {
  if (size === 'compact') {
    return (
      <span className="text-[10px] text-th-text3/60" aria-label="Data provided by Discogs">
        via{' '}
        <a
  ...
  return (
    <div className="flex items-center justify-center gap-2 pt-2" aria-label="Data provided by Discogs">
      {/* Vinyl disc icon */}
      <svg className="w-4 h-4 text-th-text3/60" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
      ...
      <p className="text-[10px] text-th-text3/60">
        Powered by{' '}
        <a
          href="https://www.discogs.com"
          target="_blank"
